...
function NftPage(props) {
    ...
    useEffect(() => {
        console.log('THIS IS SLUG ID: ', slugId);
        axios.get(`https://api.opensea.io/api/v1/assets?order_by=sale_date&order_direction=desc&offset=0&limit=20&collection=${slugId}`)
            .then((response) => {
